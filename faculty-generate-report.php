...
if (empty($_GET['subject'])) {
    header("Location: faculty-display-feedback.php?error=Please select a subject to generate the report");
    exit();
}
...
if ($teacher) {
    ...
    $params[] = $teacher;
    $types .= "s";
    $filter_description .= ", Teacher: " . htmlspecialchars($teacher);
}
...
if ($year) {
    ...
    $params[] = $year;
    $types .= "i";
    $filter_description .= ", Year: " . htmlspecialchars($year);
}
...
<head>
    ...
    <title>Faculty Report - College Feedback System</title>
        ...
        <div class="report-container">
            ...
            <?php if ($report_data && $report_data['total_feedbacks'] > 0) : ?>
                ...
                <div class="button-group">
                    ...
                    <a href="faculty-display-feedback.php" class="btn-report">Back to Feedbacks</a>
                </div>
                    ...
                    const coChart = new Chart(ctx, {
                        ...
                        options: {
                            ...
                            plugins: {
                                title: {
                                    display: true,
                                    text: 'Faculty Outcome Ratings Analysis',
                                    font: {
                                        size: 18
                                    }
                                },
