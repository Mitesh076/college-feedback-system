...
$teachers = [];
$teacher_sql = "SELECT DISTINCT teacher FROM faculty_feedback";
if (isset($_GET['department']) && $_GET['department'] != '') {
    $teacher_sql .= " WHERE department = '" . $conn->real_escape_string($_GET['department']) . "'";
    if (isset($_GET['semester']) && $_GET['semester'] != '') {
        $teacher_sql .= " AND semester = '" . $conn->real_escape_string($_GET['semester']) . "'";
    }
} else {
    if (isset($_GET['semester']) && $_GET['semester'] != '') {
        $teacher_sql .= " WHERE semester = '" . $conn->real_escape_string($_GET['semester']) . "'";
    }
}
$teacher_sql .= " ORDER BY teacher ASC";
...
if (isset($_GET['department']) && isset($_GET['semester'])) {
    ...
    $sql = "SELECT DISTINCT subject_name FROM faculty_feedback WHERE department = '$dept' AND semester = '$sem'";
...
if (isset($_GET['delete_id'])) {
    ...
    $sql = "DELETE FROM faculty_feedback WHERE id = ?";
...
<head>
    ...
    <title>View Faculty Feedback - College Feedback System</title>
    <style>
        :root {
...
<body>
    <div class="container">
        <h1>Faculty Feedback Entries</h1>
        ...
        <div class="filters">
            <form method="get">
                        ...
                        <select name="teacher" id="teacher" onchange="this.form.submit()">
                            ...
                            <?php foreach ($teachers as $teacher) { ?>
                                <option value="<?php echo htmlspecialchars($teacher); ?>" 
                                    <?php if (isset($_GET['teacher']) && $_GET['teacher'] == $teacher) echo 'selected'; ?>>
                ...
                <div style="text-align: center; margin-top: 15px;">
                    ...
                    <a href="faculty-display-feedback.php" style="margin-left: 10px; color: var(--accent-color); text-decoration: none;">Reset Filters</a>
                </div>
            </form>
        </div>
        ...
        <?php if ($result->num_rows > 0) { ?>
                                ...
                                <td>
                                    <button class="action-btn delete-btn" 
                                            onclick="if(confirm('Are you sure you want to delete this feedback?')) { 
                                                window.location.href='faculty-display-feedback.php?delete_id=<?php echo $row['id']; ?>' 
                                            }">
                                        Delete
                                    </button>
                                </td>
            ...
            <div class="button-group">
                <form method="get" action="faculty-generate-report.php">
                    ...
                    <?php if (isset($_GET['teacher'])) : ?>
                        <input type="hidden" name="teacher" value="<?php echo htmlspecialchars($_GET['teacher']); ?>">
                    <?php endif; ?>
                ...
                <form method="post" action="faculty-export-to-excel.php">
                    <?php if (isset($_GET['department'])) : ?>
                        <input type="hidden" name="department" value="<?php echo htmlspecialchars($_GET['department']); ?>">
                    <?php endif; ?>
                    <?php if (isset($_GET['semester'])) : ?>
    ...
    <script>
        // Auto-submit form when department, semester, or teacher changes
