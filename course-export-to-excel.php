...
// Get filtered data
$sql = "SELECT * FROM course_feedback WHERE $where ORDER BY submission_date DESC";
...
header('Content-Disposition: attachment; filename="course_feedback_'.date('Y-m-d').'.xls"');
